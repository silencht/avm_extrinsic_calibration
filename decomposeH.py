...
parser.add_argument('-path_h', default='./extrinsic/back_H.npy', type=str, help='Camera H File Path')
parser.add_argument('-path_k', default='./intrinsic/back_K.npy', type=str, help='Camera K File Path')
